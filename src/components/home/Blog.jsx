...
import { Image2, Image3, MalaysiaImage } from '../../assets';
  ...
  const blogPosts = [
    {
      ...
      image: "/images/banner1.webp", // Mountain/Hiking
    },
    {
      id: 2,
    ...
    },
    {
      ...
      image: MalaysiaImage, // Temple/City
    },
  ];
      ...
      <div className="w-11/12 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-10">
          ...
          <div className="flex flex-col justify-between h-full">
            ...
            {/* Header Text Section */}
            <div className="mb-5">
              <h6 className="text-4xl md:text-4xl xl:text-5xl font-messiri font-medium text-black leading-[1.15] mb-5">
            ...
            <div className="hidden xl:block relative w-full aspect-video rounded-3xl overflow-hidden group cursor-pointer">
              ...
              <div className="absolute bottom-0 left-0 p-5 md:p-7 w-full">
                <h6 className="text-2xl md:text-3xl font-messiri text-white mb-3 leading-tight max-w-sm">
            ...
            {blogPosts.map((post) => (
              <div key={post.id} className="flex flex-col md:flex-row gap-3 items-center group cursor-pointer">
                ...
                <div className="w-full md:w-1/2 flex flex-col gap-2 justify-center py-2">
                  <h6 className="md:text-lg font-messiri font-medium text-black leading-snug">
                    {post.title}
                  </h6>
