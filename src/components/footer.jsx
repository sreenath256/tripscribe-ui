...
import { Image4, LogoWhite } from '../assets';
    ...
    <footer className="w-full font-Quicksand">
      ...
      <div className="relative w-full h-[400px] xl:h-[500px] flex items-center justify-center bg-gray-900">
        ...
        <div className="relative z-10 px-6 text-center max-w-3xl mx-auto space-y-6">
          <h6 className="font-messiri text-4xl md:text-5xl lg:text-6xl text-white leading-tight">
      ...
      <div className=" bg-[#0b0502] text-white pt-20 pb-8 ">
        ...
        <div className="w-11/12 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-8 border-b border-white/10 pb-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            <Link to={'/'} aria-label="Go to TripScribe homepage" className="text-4xl text-white tracking-wide cursor-pointer font-messiri transition-all duration-200">
              <img width="240" height="64" className='-ml-4 h-16 object-contain transition-all duration-200' src={LogoWhite} alt="" />
            </Link>
            ...
            <div className="flex items-center gap-6 pt-2">
              <a
                ...
                href="https://www.instagram.com/tripscribe.in"
                target='_blank'
          ...
          <div className="lg:col-span-2 space-y-6">
            <h6 className="text-2xl font-messiri text-white">Page</h6>
          ...
          <div className="lg:col-span-2 space-y-6">
            <h6 className="text-2xl font-messiri text-white">Important Link</h6>
            <ul className="space-y-4 text-sm text-gray-400">
          ...
          <div className="lg:col-span-4 space-y-6">
            <h6 className="text-2xl font-messiri text-white">Contact Us</h6>
        ...
        <div className="w-11/12 mx-auto flex flex-col md:flex-row items-center justify-between text-xs text-white/80 gap-4">
